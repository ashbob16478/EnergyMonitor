...
local ac=_c:gsub(".lua","")ab[ac]=da(ac)end end;return ab end;aa["plugins"]={}
...
_c:addForegroundBox(ac+1,2,1,bc,cb)_c:addForegroundBox(2,bc+1,ac,1,cb)end end end)end}return db end}end;aa["libraries"]={}
...
dd:addEvent("mouse_click",a_a)dd:addEvent("mouse_up",a_a)end
if(b_a=="mouse_release")then dd:addEvent("mouse_up",a_a)end;dd:addEvent(b_a,a_a)end;ad:registerEvent(b_a,c_a)
...
aaa(bba,caa+1)end end end;for baa,caa in ipairs(a_a:getChildren())do aaa(caa,1)end end)end}b_a.__index=b_a;return setmetatable(b_a,_c)end end;return aa["main"]()