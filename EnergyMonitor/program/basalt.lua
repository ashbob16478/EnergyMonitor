...
local function ab(bb,cb)local db=0;local _c=0;local ac=0
local bc,cc=bb:getSize()
local dc={getFlexGrow=function(_d)return db end,setFlexGrow=function(_d,ad)db=ad;return _d end,getFlexShrink=function(_d)return _c end,setFlexShrink=function(_d,ad)_c=ad;return _d end,getFlexBasis=function(_d)return
...
__a:addBG(1,n,bb[_aa]:rep(a_a))__a:addFG(1,n,bb[d_a]:rep(a_a))end end end)end}dd.__index=dd;return setmetatable(dd,_c)end end;return aa["main"]()